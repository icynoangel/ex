...
(function init() {
  ...
  Promise.all( [
    fetch('/ex/js/src/reverse-words.js'),
    fetch('/ex/js/src/unique-character.js'),
    fetch('/ex/js/src/second-minimum.js'),
    fetch('/ex/js/src/repeating-characters.js'),
    fetch('/ex/js/src/power-of-ten.js'),
    fetch('/ex/js/src/minimul-length-subarray-with-sum-higher.js'),
    fetch('/ex/js/src/insertion-sort.js'),
    fetch('/ex/js/src/selection-sort.js'),
    fetch('/ex/js/src/merge-sort.js'),
    fetch('/ex/js/src/quick-sort.js'),
    fetch('/ex/js/src/binary-search-tree.js'),
    fetch('/ex/js/src/best-offers.js'),
    fetch('/ex/js/src/overlapping-rectangles.js'),
    fetch('/ex/js/src/column-name-from-number.js'),
    fetch('/ex/js/src/sum-tree.js'),
    fetch('/ex/js/src/balanced-tree.js'),
    fetch('/ex/js/src/sort-stack.js')
  ] )
  .then( ( responses ) => {
